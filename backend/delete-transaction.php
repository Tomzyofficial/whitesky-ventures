  ...
  <main>
    <div class="bg-white relative mx-auto w-[90%] h-[fit-content] my-[150px] pb-10 ring-1 ring-gray-300 md:w-[65%]">
      <div class="flex flex-col text-center py-5">
        <h3 class="text-slate-600 font-extrabold pt-5 capitalize">Delete Transaction Information</h3>
      </div>
      ...
      ?>
      <!-- input field -->
      <form action="delete-transaction.inc.php?id=<?= $searchParam;?>" method="POST">
        <div class="mx-5 space-y-4 grid grid-cols-1 md:grid-cols-2 md:space-y-0">
          ...
          <div class="relative md:ml-2">
            ...
            <input disabled type="text" id="status" name="status" value="<?= htmlentities($status);?>" class="caret-blue-300 w-[100%] rounded-sm ring-1 ring-gray-300 p-2 outline-none focus:ring-2 focus:ring-blue-300">
          </div>
          <!-- date -->
          <div class="relative md:mr-2">
