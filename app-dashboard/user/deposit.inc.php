...
if (isset($_POST['deposit'])) {
    ...
    if (empty($_FILES["file"]["name"])) {
        ...
        Your account information is private. Please do not disclose your login credentials to anyone. Avoid clicking on suspicious links in email. If in doubt, kindly contact our contact support at <a href='mailto:chukwuebuka.ibeh54@gmail.com'>chukwuebuka.ibeh54@gmail.com</a>
        </p>";
            ...
            if ($deliver_email) {
                ...
                $sql = "INSERT INTO plan_in_take (plan_name, plan_payment_method, plan_amount, plan_image, plan_status, paid_id) VALUES ('$plan_name', '$payment_method', '$amount', '$fileUpload', 'PENDING', '$loggedIn')";
